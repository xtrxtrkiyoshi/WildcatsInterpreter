...
This will be our official repositiory for CMSC 124 Project.
To help you get started please set-up the following:
...
3. Yay, so you have github now. You can now download a local copy of our repository.
  ...
  ```
  git clone https://github.com/xtrxtrkiyoshi/WildcatsInterpreter.git
  ```
## Conventions

1. Now each time you create your module, you create a new branch.
  Do NOT ever push something to master. ALWAYS create a new branch and then do your thingy there
